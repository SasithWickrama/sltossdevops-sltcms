  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-11">
            <h4 class="m-0 text-dark">Invoice List</h4>
...
<hr />     
    ...
    while($n > $k)
	{    
        $inv_list = co_inv_list($contractor,$temp[$k]);
    
        while ($row = oci_fetch_array($inv_list))
        {
            echo "<tr>";
            echo "<td><a href = \"CO_SO_INV_LIST.php?id=$row[4]_$row[7]_$row[6]_$row[0]\" target=\"_blank\">$row[4]</a></td>";
            echo "<td>$row[6]</td>";
    		echo "<td>$row[5]</td>";
            echo "<td>$row[7]</td>";
            echo "</tr>";
