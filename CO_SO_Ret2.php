...
$empty_result_set = true;
   $i=1;
    ...
    if ($areanew == 'ALL')
    {
	$HEADER ="NO,Circuit NO,Service Order NO,Received Date,Returned Date,Returned Reason,Order Type\n";
      $so_con_comp_list = so_con_ret_all($fromdate,$todate,$sertyp,$ortyp,$contractor_name);			
	echo" <div class=\"panel-body\">
		...
		$HEADER = $HEADER . "{$i},{$row[0]},{$row[1]},{$row[2]},{$row[3]},{$row[4]},{$row[5]}\n";
		$i++;
		}
    ...
    // No rows in the result set.
       ...
       // echo "<script type='text/javascript'>document.location = \"CO_SO_Ret.php\";</script>";
		}	
	...
	{
	$HEADER ="NO,Circuit NO,Service Order NO,Received Date,Returned Date,Returned Reason,Order Type\n";
      $so_con_comp_list = so_con_ret_li($fromdate,$todate,$areanew,$sertyp,$ortyp,$contractor_name);			
	echo" <div class=\"panel-body\">
    ...
    // No rows in the result set.
       ...
       // echo "<script type='text/javascript'>document.location = \"CO_SO_Ret.php\";</script>";
		...
		$File = "soreports/{$areanew}_{$contractor_name}_returnedso.csv";
