...
function update_cir_inv($invoice_no,$con_name,$area,$sertype,$todate)
{
    if($sertype == 'IPTV'){
    ...
    and A.QTY_SLT_DATE < TO_DATE('$todate 11:59:59 PM','mm,dd,yyyy:hh:mi:ss pm')
...
function update_cir_inv2($invoice_no,$con_name,$area,$sertype,$todate)
{
    if($sertype == 'IPTV'){
...
function comp_count($area,$con_name,$sertype,$todate)
{
   if($sertype == 'IPTV'){
