...
<hr />
   ...
   $i=1;
	...
	$HEADER = "NO,Circuit NO,Service Order NO,Received Date,Completed Date,Task Name,Delayed Days,Penalty,Approved,Order Type\n";
      $so_con_comp_list = so_con_comp_allap($fromdate,$todate,$sertyp,$ortyp,$contractor_name,$areanew);			
    ...
    // No rows in the result set.
        ...
        echo "<script type='text/javascript'>document.location = \"CO_SO_CON_Compap.php\";</script>";
		}	
	...
	{
	$HEADER = "NO,Circuit NO,Service Order NO,Received Date,Completed Date,Task Name,Delayed Days,Penalty,Approved,Order Type\n";
      $so_con_comp_list = so_con_comp_liap($fromdate,$todate,$areanew,$sertyp,$ortyp,$contractor_name);			
	echo" <div class=\"panel-body\">
